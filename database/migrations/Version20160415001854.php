...
class Version20160415001854 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        (new Builder($schema))->create('posting_events', function(Table $table) {
    ...
    {
        (new Builder($schema))->drop('posting_events');
    }
}
