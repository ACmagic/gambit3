...
class Version20160414000030 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        (new Builder($schema))->create('account_types', function(Table $table) {
    ...
    {
        (new Builder($schema))->drop('account_types');
    }
}
