...
class Version20160322013646 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        (new Builder($schema))->create('quote_point_spreads', function(Table $table) {
    ...
    public function down(Schema $schema)
    {
        ...
        (new Builder($schema))->drop('quote_point_spreads');
